...
$avatarSrc = isset($old_data['avatar']) && !empty($old_data['avatar']) ? htmlspecialchars($old_data['avatar']) : $defaultAvatar;
    ...
    <div class="container d-flex justify-content-center align-items-center vh-100">
        <div class="form-container">
            <h3 class="text-center mb-3">Create New Admin</h3>
            ...
            <form action="/admin/create-admin" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-3">
                    ...
                    <select name="role_type" class="form-control">
                        <option value="1" <?php echo(isset($old_data['role_type']) && $old_data['role_type'] == "1") ? 'selected' : ''; ?>>Super Admin</option>
                        <option value="2" <?php echo(isset($old_data['role_type']) && $old_data['role_type'] == "2") ? 'selected' : ''; ?>>Admin</option>
                    </select>
